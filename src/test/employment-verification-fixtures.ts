...
export function makeVerificationEvidenceItem(
  ...
  return {
    ...
    value: { employer_name: "KairoID Labs" },
    status: "Approved",
...
export function makeBackendVerificationRequestResponse(
  ...
  return {
    ...
    target_organization_name: "KairoID Labs",
